...
function setup() {
  ...
  for (let i = 0; i < 20; i++) {
    vehicles.push(new Vehicle(random(width), random(height), 15));
  }
}
...
class Vehicle {
  ...
  setBarriers(){
    for(let i=0;i<15;i++){
      ellipse(200+i*20,200,this.barrierRadius,this.barrierRadius)
      this.repelled(createVector(200+i*20,200))
      ellipse(200,200+i*10,this.barrierRadius,this.barrierRadius)
      this.repelled(createVector(200,200+i*10))
      ellipse(200+i*20,350,this.barrierRadius,this.barrierRadius)
      this.repelled(createVector(200+i*20,350))
      ellipse(500,200+i*10,this.barrierRadius,this.barrierRadius)
